...
displayIdleScreen = function() {
	...
	document.getElementById("top-button").className = 'install-idle-dl';
...
var clickDownload = function() {
	if (typeof mnUserClickDownload != 'undefined') {
		...
		window.location.href = 'https://itunes.apple.com/us/app/big-fish-casino-free-vegas/id538212549?mt=8';
	}
}
/********** OUTRO SPECIFIC JAVASCRIPT **********/